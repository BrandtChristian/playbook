...
// --- Social icon PNGs (Supabase Storage CDN) ---
// Icons hosted in the public `email-images` bucket for reliable delivery in email clients.

const SUPABASE_ICONS_BASE = `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/email-images/icons`;
...
function getSocialIcon(platform: string, style: SocialIconStyle = "color"): string {
  ...
  const src = `${SUPABASE_ICONS_BASE}/${dir}/${platform}.png`;
